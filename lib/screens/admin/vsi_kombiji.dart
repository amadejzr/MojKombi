...
class AllCombies extends StatefulWidget {
  const AllCombies({Key? key}) : super(key: key);

  @override
  _AllCombiesState createState() => _AllCombiesState();
}

class _AllCombiesState extends State<AllCombies> {
